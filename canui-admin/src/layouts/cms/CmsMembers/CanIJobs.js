...
class CanIJobs extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			data: {},
	...
	getJobsList = async (_uid) => {
        ...
        _op.pickupUserId = this.props.data.userId;
					...
					<div className="col-12">
						<table>
							<tbody>
								<tr>
									<th>
										<div>Jobs Applying <strong>({this.state?.JobsPending?.length || 0})</strong></div>
									</th>
